...
"""IANA zone names this firmware accepts (generated).
...
Mirrors k_tz_zones in components/timezone/tz_zone_table.inc: 598 names
from IANA tzdata 2026c sharing 94 POSIX rules. Kept as its own

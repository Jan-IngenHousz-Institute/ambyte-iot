/* Minimal SHA-256 (FIPS 180-4) for the harness manifests. Public-domain style,
 * written for this harness; verified against the empty-string and "abc"
 * vectors by run.py's self-check. */
#include <stdint.h>
#include <stdio.h>
#include <string.h>
